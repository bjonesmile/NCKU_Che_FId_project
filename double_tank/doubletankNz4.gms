...
;
        ...
        qin1(m)$(ord(m) lt 200) ..  qin(m+1) =e= qin(m) ;
        qin2(m)$((ord(m) gt 200) and (ord(m) lt 400)) ..  qin(m+1) =e= qin(m) ;
        qin3(m)$((ord(m) gt 400) and (ord(m) lt 600)) ..  qin(m+1) =e= qin(m) ;
        qin4(m)$((ord(m) gt 600) and (ord(m) lt 800)) ..  qin(m+1) =e= qin(m) ;
        qin.up(m) = 0.4;
        qin.lo(m) = 0.0;
