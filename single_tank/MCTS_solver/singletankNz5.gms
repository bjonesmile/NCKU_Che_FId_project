...
$gdxin
        ...
        qout1(m)$(ord(m) lt 160) ..    qout(m+1) =e= qout(m) ;
        qout2(m)$((ord(m) gt 160) and (ord(m) lt 320)) ..    qout(m+1) =e= qout(m) ;
        qout3(m)$((ord(m) gt 320) and (ord(m) lt 480)) ..    qout(m+1) =e= qout(m) ;
        qout4(m)$((ord(m) gt 480) and (ord(m) lt 640)) ..    qout(m+1) =e= qout(m) ;
        qout5(m)$((ord(m) gt 640) and (ord(m) lt 800)) ..    qout(m+1) =e= qout(m) ;
        h.fx('1') = h0;
